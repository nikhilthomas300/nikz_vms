...
export default function KioskPage() {
  const [currentStep, setCurrentStep] = useState<'welcome' | 'scan' | 'search' | 'confirm' | 'complete'>('welcome')
  ...
  if (loading) {
    return <GlobalLoader isLoading={true} text={isScanning ? "Scanning QR Code..." : "Processing..."} />
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950 flex items-center justify-center">
        <LoadingSpinner 
          fullScreen 
          size="xl" 
          text={isScanning ? "Scanning QR Code..." : "Processing check-in..."} 
        />
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              ...
              <div>
                ...
                <p className="text-lg text-slate-600 dark:text-slate-300">Self-Service Kiosk</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <AnimatePresence mode="wait">
                ...
                <CardContent className="pb-12">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    <motion.div variants={itemVariants}>
                      <Button
                        size="lg"
                        className="w-full h-48 bg-gradient-to-br from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 group"
                      ...
                      >
                        <div className="flex flex-col items-center space-y-4">
                          ...
                          <div className="text-center">
                            ...
                            <div className="text-blue-100 text-lg">Quick & Secure</div>
                          </div>
                        </div>
                      </Button>
                    </motion.div>
                    ...
                    <motion.div variants={itemVariants}>
                      <Button
                        size="lg"
                        className="w-full h-48 bg-gradient-to-br from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 group"
                        onClick={() => setCurrentStep('search')}
                      >
                        <div className="flex flex-col items-center space-y-4">
                          <Search className="h-16 w-16 group-hover:scale-110 transition-transform duration-300" />
                          <div className="text-center">
                            <div className="text-2xl font-bold">Search Visit</div>
                            <div className="text-purple-100 text-lg">Find by Name</div>
                          </div>
                        </div>
                      </Button>
                    </motion.div>
          ...
          {/* Other screens follow similar pattern... */}
        </AnimatePresence>
      </div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          {currentStep === 'scan' && (
            ...
            >
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-0 shadow-2xl">
                <CardHeader className="text-center">
                  <motion.div variants={itemVariants}>
                    <CardTitle className="text-3xl font-bold mb-4">Scan Your QR Code</CardTitle>
                ...
                <CardContent className="pb-8">
                  <motion.div variants={itemVariants} className="space-y-8">
                    <div className="relative aspect-square max-w-md mx-auto">
                      ...
                      <div className="absolute inset-4 border-4 border-dashed border-blue-400 rounded-xl flex items-center justify-center bg-slate-50/50 dark:bg-slate-800/50">
                        <div className="text-center">
                          <Camera className="h-20 w-20 mx-auto mb-4 text-blue-500 animate-pulse" />
                          <p className="text-xl font-semibold text-slate-700 dark:text-slate-300">Camera Active</p>
                          <p className="text-slate-500 dark:text-slate-400">Position QR code here</p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                      <Button size="lg" onClick={handleQrScan} className="px-8">
          ...
          {currentStep === 'search' && (
            ...
            >
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-0 shadow-2xl">
                <CardHeader className="text-center">
                  <motion.div variants={itemVariants}>
                    <CardTitle className="text-3xl font-bold mb-4">Find Your Visit</CardTitle>
                    <CardDescription className="text-lg">
                      Search by your name or company name
                    </CardDescription>
                  </motion.div>
                </CardHeader>
                  ...
                  <motion.div variants={itemVariants} className="space-y-6">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="pl-12 h-16 text-xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border-2 focus:border-blue-400 rounded-xl"
                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                      {mockVisitors
                        ...
                        <motion.div
                          ...
                          className="p-6 border-2 border-slate-200 dark:border-slate-700 rounded-xl hover:border-blue-400 dark:hover:border-blue-400 cursor-pointer transition-all duration-300 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm hover:shadow-lg"
                          onClick={() => {
                            setSelectedVisitor(visitor)
                            setCurrentStep('confirm')
                          }}
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                <p className="text-xl font-bold text-slate-900 dark:text-white">{visitor.name}</p>
                                <div className="flex items-center space-x-4 text-slate-600 dark:text-slate-300">
                            ...
                            <div className="text-right">
                              <div className="flex items-center space-x-2 text-lg font-bold text-slate-900 dark:text-white mb-2">
                                <Clock className="h-5 w-5" />
                                <span>
          ...
          {currentStep === 'confirm' && selectedVisitor && (
            ...
            >
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-0 shadow-2xl">
                <CardHeader className="text-center">
                  <motion.div variants={itemVariants}>
                    <CardTitle className="text-3xl font-bold mb-4">Confirm Check-in</CardTitle>
                    <CardDescription className="text-lg">
                      Please verify your visit details
                    </CardDescription>
                  </motion.div>
                </CardHeader>
                ...
                <CardContent className="pb-8">
                  <motion.div variants={itemVariants} className="space-y-8">
                    <div className="text-center">
                      ...
                      <div className="bg-slate-50/80 dark:bg-slate-800/80 rounded-2xl p-6 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="flex items-center space-x-3">
                            <Users className="h-6 w-6 text-blue-600" />
                            <div>
                              <p className="text-sm text-slate-500 dark:text-slate-400">Host</p>
                              <p className="font-semibold text-lg">{selectedVisitor.host}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="font-semibold text-lg">
                                {new Date(selectedVisitor.scheduledTime).toLocaleString()}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="font-semibold text-lg">Main Building</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="font-semibold text-lg">1 hour</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                      <Button 
                        size="lg" 
                        onClick={handleCheckIn} 
                        className="px-12 py-6 text-xl bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700"
                      >
              ...
              <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-0 shadow-2xl">
                <CardContent className="pt-12 pb-12">
                  <motion.div variants={itemVariants} className="text-center space-y-8">
                    ...
                    >
                      <div className="w-32 h-32 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full mx-auto flex items-center justify-center mb-6">
                    ...
                    <div>
                      ...
                      <div className="bg-green-50/80 dark:bg-green-900/20 rounded-2xl p-6 mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-sm text-green-700 dark:text-green-400">Badge Number</p>
                            <p className="text-2xl font-bold text-green-800 dark:text-green-300">
                              #V{Math.floor(Math.random() * 1000).toString().padStart(3, '0')}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm text-green-700 dark:text-green-400">Check-in Time</p>
                            <p className="text-2xl font-bold text-green-800 dark:text-green-300">
                              {currentTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                            </p>
                          </div>
        ...
        {/* Completion Screen - handled above in the new design */}
        </AnimatePresence>
      </div>
    </div>
  )
